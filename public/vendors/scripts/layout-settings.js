(function () {
	...
	$(document).ready(function () {
		...
		// Always keep left sidebar white in every page/section
		...
		sidebar_dark.click(function () {
			"use strict";
			// Sidebar dark option disabled: project sidebar must stay white everywhere
			jQuery(this).removeClass("active");
			sidebar_light.addClass("active");
